...
## Phase 2: UX/UI 개선 & SEO (예정)

- [ ] 2.1 Next.js `<Image>` 최적화 (19개 파일)
- [ ] 2.2 SEO: 메타태그, OG, sitemap, robots, JSON-LD
- [ ] 2.3 다음 주소 API 연동
- [ ] 2.4 로딩/에러 상태 (`loading.tsx`, `error.tsx`)
- [ ] 2.5 검색 성능 개선 (Firestore 쿼리 최적화)
- [ ] 2.6 홈페이지 리뷰 실데이터 연동

## Phase 3: 고급 기능 (예정)

- [ ] 3.1 디자인 에디터 고도화 (Canvas/Fabric.js)
- [ ] 3.2 단체/대량 주문 시스템
- [ ] 3.3 리뷰 시스템 강화 (사진 리뷰, 별점 분포)
- [ ] 3.4 실시간 주문 알림
- [ ] 3.5 테스트 환경 구축 (Vitest)

## Phase 4: 크리에이터 플랫폼 & 소셜 커머스 (예정)

- [ ] 4.1 크리에이터 마켓플레이스 (등록/대시보드/스토어/정산)
- [ ] 4.2 소셜 커머스 (카카오 공유, 카카오/네이버 로그인)
- [ ] 4.3 AI 디자인 쇼케이스 & 커뮤니티
- [ ] 4.4 상품 카탈로그 확장 (인쇄 방식별)
